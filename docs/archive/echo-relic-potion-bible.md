...
> This roster predates 共鳴武者 and contains 回音-specific content that is
> incompatible with the live character. `初心音叉` remains live only through
> `src/data/relics.ts`, where it grants +1 damage to the first Attack hit each
